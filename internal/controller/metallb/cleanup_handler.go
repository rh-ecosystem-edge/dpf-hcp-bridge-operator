...
// 1. Deleting IPAddressPool created for this DPFHCPBridge
// 2. Deleting L2Advertisement created for this DPFHCPBridge
...
// Cleanup deletes MetalLB resources (IPAddressPool and L2Advertisement) created for this DPFHCPBridge.
